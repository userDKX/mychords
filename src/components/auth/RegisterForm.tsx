      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-700">
        <div className="bg-white/[0.02] border border-white/[0.05] p-8 md:p-10 rounded-[2.5rem] backdrop-blur-xl shadow-2xl relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-slate-400 font-medium tracking-wide">Crea tu cuenta gratis</p>
          </div>
          ...
          <p className="mt-8 text-center text-sm font-medium text-slate-400">
            ¿Ya tienes cuenta?{' '}
            <Link to="/login" className="text-brand-400 hover:text-brand-300 hover:underline underline-offset-4 transition-all">Inicia sesión</Link>
          </p>
        </div>
      </div>
    </div>
